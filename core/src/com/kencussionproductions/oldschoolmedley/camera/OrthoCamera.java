package com.kencussionproductions.oldschoolmedley.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(OldSchoolMedley.WIDTH, OldSchoolMedley.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(OldSchoolMedley.WIDTH, OldSchoolMedley.HEIGHT);  
